...
export async function deleteThisAndFuture(send) {
  ...
  // Zbierz ID przyszłych wysyłek z tej serii (od send.sendDate w przód)
  ...
  if (send.id === pid) idsToDelete.push(pid);

  // Wyczyść linkedSendId w taskach które wskazują na którąkolwiek z usuwanych wysyłek
